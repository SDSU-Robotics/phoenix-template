...
Listener::Listener()
{
	...
	//PID Constants
	motorProfile.slot0.kP                       = 20.0f; //0.01f; //Propotional Constant.  Controls the speed of error correction.
	motorProfile.slot0.kI                       = 0.0f; //Integral Constant.     Controls the steady-state error correction.
	motorProfile.slot0.kD                       = 10.0f; //Derivative Constant.   Controls error oscillation.
	...
	motorProfile.slot0.allowableClosedloopError = 2.0;   //If the total error-value is less than this value, the error is automatically set to zero.
